...
const tempoGasto:number = leitor.questionInt("Quanto tempo você leva:")
const velocidadeMedia:number = leitor.questionInt("Qual sua Velocidade:")

let KM: number =((tempoGasto / 12) * velocidadeMedia  )
